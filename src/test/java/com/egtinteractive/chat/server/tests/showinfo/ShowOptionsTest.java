...
import static com.egtinteractive.chat.server.tests.resources.TestUtils.CMD_SHOW_OPTIONS;
...
public class ShowOptionsTest {
  ...
  @Test
  public void showOptionsTest() throws IOException {
    final Client client = new Client(userName, clients, PORT);
    initialize(client);
    client.writeLine(CMD_SHOW_OPTIONS);
    assertEquals(client.readLine(), "COMMANDS:");
  }
